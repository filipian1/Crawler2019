...
* data[0] 
		data = 0  - nic nie robi
		data = 1  - resetuje statusy b³êdów
		data = 2  - prze³¹cza w tryb pracy bez sprzê¿enie od prêdkoœci (PWM MODE)
...
* ID - 45
* data[0] - pozycja w pionie -100  - 100 (zadajesz pozycjê)
* data[1] - polecenie przezuñ w lewo/ prawo -100  - 100  (zadajesz ¿e ma siê przesun¹æ, nie trzyma pozycji)
* data[3] - zabij to gówno (jak wyœlesz 0x01 to wy³¹czy napêdy) (na wypadek jakby coœ posz³o nie tak mocno), (jak wyœlesz 0x02 to zresetujesz p³ytkê)
